...
def runtest(project, scheme, test, hostApp, sdkfolder):    
    print("################################### {0} ###################################".format(test))
...
for project in projectlist:
    ...
    for test in testlist:
        ...
        if 0 != runtest(projectpath , scheme, testname, hostAppName, sdkfolder):
...
if len (faiedtestlist) > 0 :
    ...
    content = "Failed tests: " + faiedtestlist.join(", ")   
